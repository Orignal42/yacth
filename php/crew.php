<section id="crew">
<div class="card-v10 card-v10--state-2 col-2">
  <a class="card-v10__img-link radius-lg shadow-lg" href="#0">
    <img src="/YatchPrestige/images/capitain.jpg" alt="Image description">
  </a>

  <div class="card-v10__content-wrapper">
    <div class="card-v10__content bg shadow-xs radius-lg">
      <div class="card-v10__body">
        <p class="card-v10__label text-uppercase color-primary letter-spacing-md"></p>

        <div class="text-component">
          <h1 class="card-v10__title"><a class="color-contrast-higher" href="#0">Capitaine</a></h1>
          <p class="card-v10__excerpt color-contrast-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni libero quisquam aliquid.</p>
        </div>
      </div>
  ...
  <div class="card-v10__content-wrapper">
    <div class="card-v10__content bg shadow-xs radius-lg">
      <div class="card-v10__body">
        ...
        <div class="text-component">
          <h1 class="card-v10__title"><a class="color-contrast-higher" href="#0">Timonier</a></h1>
          <p class="card-v10__excerpt color-contrast-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni libero quisquam aliquid.</p>
        </div>
      </div>
  ...
  <div class="card-v10__content-wrapper">
    <div class="card-v10__content bg shadow-xs radius-lg">
      <div class="card-v10__body">
        ...
        <div class="text-component">
          <h1 class="card-v10__title"><a class="color-contrast-higher" href="#0">Raleur</a></h1>
          <p class="card-v10__excerpt color-contrast-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni libero quisquam aliquid.</p>
        </div>
      </div>
